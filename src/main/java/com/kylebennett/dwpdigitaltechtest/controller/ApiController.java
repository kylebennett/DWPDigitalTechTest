...
public class ApiController {
    ...
    public SearchResult getUsersWithin50MilesOfLondon() {
    ...
    public SearchResult getUsersWithinDistanceOfLocation(@RequestParam(name = "locationName") String locationName,
